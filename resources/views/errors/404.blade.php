    ...
    <div class="bg-white dark:bg-neutral-800 rounded-2xl shadow-2xl overflow-hidden">
        <div class="p-8 md:p-12">
            ...
            <div class="text-center">
                <div
                    class="inline-flex items-center justify-center w-20 h-20 rounded-full bg-blue-100 dark:bg-blue-900/30 mb-2">
                ...
                <h1 class="font-bold text-blue-600 dark:text-blue-400 mb-2 leading-0" style="font-size: 4.5rem;">404</h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="{{ route('home') }}"
                        class="px-6 py-3 bg-blue-600 dark:bg-blue-500 text-white rounded-lg font-semibold hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors duration-200">
                        <span class="flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
